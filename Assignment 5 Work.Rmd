...
When taking a year-by-year look into it, I discovered that it was a flat rate of 111 property crimes each state, and 148 violent crimes each year. This let me know that the dataset might be skewed in some way due to the consistency of crimes.
```{r, echo=FALSE}
crime_3 <- crime %>%
